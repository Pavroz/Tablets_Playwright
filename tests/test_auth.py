...
class TestAuth:
    ...
    @pytest.mark.auth
    def test_correct_login(self, open, auth_page):
    ...
    @pytest.mark.auth
    def test_active_recovery_conf(self, open, auth_page):
    ...
    @pytest.mark.auth
    def test_inactive_recovery_conf(self, open, auth_page):
